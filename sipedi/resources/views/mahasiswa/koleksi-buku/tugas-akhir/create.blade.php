<x-module.mahasiswa>
    <x-template.button.back-button url="pegawai/koleksi-buku/tugas-akhir" />
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ url ('pegawai/koleksi-buku/tugas-akhir') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
